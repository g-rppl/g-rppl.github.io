...
author:
  - name: "**Georg Rüppel**"
    ...
    email: georg.rueppel2@jordsand.de
...
<div style="text-align: center; font-size: 150px; padding-top: 320px; padding-left: 50px"> 
  --- Tiny but &nbsp; &nbsp; &nbsp; &nbsp; ---
  <img src="figures/shiny-hex.png" width="10%" style="position: absolute; top: 200px; right: 560px">
</div>'
