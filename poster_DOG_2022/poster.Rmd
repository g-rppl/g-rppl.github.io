...
Individual migratory decisions during autumn migration likely depend on **migration strategy**, i.e. short- to medium- or long-distance migrants, and birds of both strategies differently react to prevailing environmental conditions at stopover [@packmor2020]. However, it remains unclear whether migration strategy similarly affects the adjustment of migratory decisions during spring, when early arrivals at the breeding grounds should be mutually beneficial for individual reproductive fitness.
