...
<div style="text-align: center"> 
  <img src="figures/map_bean.svg" style="padding-top:30px"> <img src="figures/bean.png" width="1%" style="position: absolute; top: 65px; right: 600px"> [\*]{style="color: #cc0000; font-size: 120px"} 
</div>'
