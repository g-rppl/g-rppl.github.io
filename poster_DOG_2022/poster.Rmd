...
# Results
<center>
![Mean departure probability and mean probability for offshore flights per species group and migration strategy during spring. The overall means are indicated by horizontal lines.](figures/mean.svg){width="70%"}
</center>

1.  Day-to-day departure probability among species was higher in long-distance migrates independently from routing decision.
...
<img src='figures/dep_timing_2.svg' width='65%'> <img src='figures/dep_timing_3.svg' width='33%'> 
...
![Routing was predicted by both wind components with higher probabilities for an offshore flight under easterly and southerly (offshore) winds peaking at low wind speeds.](figures/dep_decision.svg){width="83%"}
...
<center>
![Birds that followed the coastline departed 0.7 days (-1.8–3.1 days) later than birds that flew offshore. Within the day of departure, onshore flights started 5.6% of night length (2.1–9.2 %) later compared to offshore flights.](figures/dep_time.svg){width="70%"}
</center>
...
::: {style="text-align: auto; display: grid; grid-template-columns: 0.2fr 1.8fr; font-size: 20pt; padding-top: 50px;"}
<div>
